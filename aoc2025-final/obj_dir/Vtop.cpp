...
Vtop::Vtop(VerilatedContext* _vcontextp__, const char* _vcname__)
    ...
    , notify_host{vlSymsp->TOP.notify_host}
    , length{vlSymsp->TOP.length}
    , mem_length{vlSymsp->TOP.mem_length}
    , src_addr{vlSymsp->TOP.src_addr}
    , dst_addr{vlSymsp->TOP.dst_addr}
    , mem_read_addr{vlSymsp->TOP.mem_read_addr}
    , mem_read_data{vlSymsp->TOP.mem_read_data}
    , glb_r_addr{vlSymsp->TOP.glb_r_addr}
    , glb_dout{vlSymsp->TOP.glb_dout}
    , rootp{&(vlSymsp->TOP)}
{

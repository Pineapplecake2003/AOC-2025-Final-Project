...
int main(){
    ...
    // int row_block_filter = 3;
    // cout << "row_block_filter: " << row_block_filter << endl;
    // int row_block_ifmap = (6 / (r * t_H));
    // cout << "row_block_ifmap: " << row_block_ifmap << endl;
